...
<html>
	...
	function ViewProcess()
		...
		function refresh()
		{
		   	 parent.frames[1].document.location.href="../docFlowsAction.do?pg=4&currentPage="+parent.frames[2].Number;
		
		}
		function refreshPre()
		{
		  	 parent.frames[1].document.location.href="../gwlzclient/docFlowsAction.do?pg=4&currentPage="+parent.frames[2].Number;
		...
		function auditFinish()
		{
		   if (confirm("确认签批吗?"))
		   {
		    ...
		    return ;
		    flowidstr = flowids;
		    alert('flowidstr zgsjsp ' + flowidstr );
		    var sUrl = "../submit/submitAction.do?oper=check&flowids="+flowids;
