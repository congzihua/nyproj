...
<html>
	...
	<script type="text/javascript">
		...
		function refreshPre()
		{
		   	 parent.frames[1].document.location.href="../gwlzclient/docFlowsAction.do?pg=1&currentPage="+parent.frames[2].Number;
		
		}
	    function refresh()
		{
		   	 parent.frames[1].document.location.href="../docFlowsAction.do?pg=1&currentPage="+parent.frames[2].Number;
						...
						<table border="0" width="800px" height="25" cellspacing="0"
							...
							<tr>
								<td width="95%" height="25">
									<font face="Wingdings" size="2">&nbsp; l </font>当前位置：公文管理 → 待核稿
								</td>
							</tr>
						</table>
					</td>
