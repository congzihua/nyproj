...
<html>
	<head>
		...
		{  
	       ...
	       var typeid =  src.getAttribute("typeid");
	       parent.main.location.href="docNumAction.do?oper=list&typeid="+typeid;
		}
	...
	<body  style="margin:0px;">
		...
		<table cellpadding=0 cellspacing=0  background="../../images/weizhi.jpg" width=100%>
		    ...
		    height:25;
		    padding:3px;">&nbsp;
						<font face="Wingdings" size="2">l </font>文号列表</font>
				</td>
			</tr>
		</table>
		<div style="margin-left:5px;margin-top:5px">
			<script language="javascript">
		     ...
		     tree = new WebFXLoadTree("公文文号", "../GetDocTypesTree.do",'','','../../xtree/images/openfoldericon.png','../../xtree/images/openfoldericon.png');
