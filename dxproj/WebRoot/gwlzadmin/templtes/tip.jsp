...
<%
 ...
 {
 %>
 <p align=center>添加模板成功,窗体将在三秒后自动关闭
...
window.setTimeout("window.close();",3000);
 ...
 {
  %>
 <p align=center>添加模板失败,窗体将在三秒后自动关闭
 <a href="javascript:window.close()" style="color:blue">[关闭]</a></p>
<script>
window.setTimeout("window.close();",3000);
</script>
...
{%>
 <p align=center>查询模板信息失败
 </p>

<%} else if (tip.equals("uploadsuccess"))
 {
%>

 <p align=center>上传模板成功,窗体将在三秒后自动关闭
 <a href="javascript:window.close()" style="color:blue">[关闭]</a></p>
<script>
window.opener.location.reload();
window.setTimeout("window.close();",3000);
</script>
<%} else if (tip.equals("uploaderror"))
{%>
 <p align=center>上传模板失败,窗体将在三秒后自动关闭
 <a href="javascript:window.close()" style="color:blue">[关闭]</a></p>
<script>
window.setTimeout("window.close();",3000);
</script>
