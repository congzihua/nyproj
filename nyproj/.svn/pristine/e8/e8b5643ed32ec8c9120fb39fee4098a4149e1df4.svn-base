...
public class XMLProperties {
	...
	/**
	 * Creates a new XMLProperties object. 修改原来build方法的参数，将原来直接传文件改为传编码后的Reader
	 * 
	 * @param file
	...
	public XMLProperties(InputStream isr) throws Exception {
		try {
			SAXBuilder builder = new SAXBuilder();
			doc = builder.build(isr);
		} catch (Exception e) {
	...
	public void setProperty(String name, String value) {
		...
		Element element = doc.getRootElement();
		for (int i = 0; i < propName.length; i++) {
			// If we don't find this part of the property in the XML
			// heirarchy
