...
<html>
	...
	function refresh()
	{
	 parent.frames[1].document.location.href="../docFlowsAction.do?pg=7&currentPage="+parent.frames[2].Number;
	...
	function bakupdoc()
	{
	  	...
	  	if (flowsid == false)
	  	return ;
	  	var sUrl = "../bakupDocAction.do?flowsid="+flowsid;
		new net.ContentLoader(sUrl, doFinishBackUpDoc); 
	}
	function doFinishBackUpDoc()
	{
						...
						<table border="0" width="800px" height="25" cellspacing="0"
							...
							<tr>
								<td width="95%" height="25">
									<font face="Wingdings" size="2">&nbsp; l </font>当前位置：公文管理 → 已办结
								</td>
							</tr>
						</table>
					</td>
								...
								<td>
									<table align="left" border="0" cellPadding="0" cellSpacing="0"
										...
										<td>
											...
											<td>
												<input type="button" value="归 档" onclick="javascript:bakupdoc();" class="buttonimg">
											</td>
											<td>
												&nbsp;
											</td>
