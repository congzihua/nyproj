...
<%
  ...
  DocEntity frm = service.getDoc(Integer.parseInt(docid)); 
  ...
  String flowsid = request.getParameter("flowsid");
   ...
   keyword.setDocid(Integer.parseInt(request
			.getParameter("docid"))) ;
   ...
   List sjList = service.getPowerGroupAdvice(keyword);
   Iterator iterSj = sjList.iterator();
      StringBuffer SjBuffer = new StringBuffer();
   while (iterSj.hasNext())
   {
      Flows flows = (Flows)iterSj.next();
      SjBuffer.append(flows.getAdvice()).append("   ").append(flows.getFlowtor()).append("   ").append(flows.getOpertime()).append("\r\n");
   }
   keyword.setPowergroup(5);
   List jxList = service.getPowerGroupAdvice(keyword);
...
<html>
	...
	<body  style="margin:0px"
		...
		<html:form action="/gwlzclient/docFinishAction.do"
			method="post">
					...
					<td>
						<table bgcolor="#000000" cellpadding="4" cellspacing="1"
							...
							<tr bgcolor="#ffffff">
								...
								<td>
									<html:text property="docnum"  value="<%=frm.getDocnum() %>"  styleClass="textbox2" name="docsForm">
									</html:text>
								</td>
								<td>
									拟稿人：
								...
								<td colspan=3>
									<select name="urgenceSelect" style="width:100px">
										...
										<option <%if (frm.getUrgence().equals("急")){%> selected <%} %>
											value="急">
											急
										</option>
							...
							<tr bgcolor="#ffffff">
								...
								<td>
									<input name="publishtimef" type="button" 
										value="<%=frm.getPublishtime()==null ? now : frm
						.getPublishtime()%>"
										size=60>
								</td>
								<td>
								...
								<td>
									<input name="publishtimem" type="button" 
						...
						.getMaketime()%>" size=60>
							...
							: frm.getPublishOrg()%>"
								...
								<td>
									<select  name="createmodeSelect" style="width:140px">
							...
							: frm.getCreateorg()%>"
								...
								<td>
									<select  name="publishlevelSelect" style="width:140px">
									...
									<table style="color: red;font-size:12">
										<tr>
											...
											<td>
												<html:textarea
													...
													cols="75" property="advice" name="docsForm" value="<%=cbcBuffer.toString() %>" rows="3" >
											</html:textarea>
										...
										<tr>
											...
											<td>
												<html:textarea
													style="BORDER: #000000 1px dotted;text-align:left;background:#ebebeb;color:red"
													cols="75" property="advice" name="docsForm" value="<%=cbbsBuffer.toString() %>" rows="3" >
											</html:textarea>
										...
										<tr>
											...
											<td>
												<html:textarea
													style="BORDER: #000000 1px dotted;text-align:left;background:#ebebeb;color:red"
													cols="75" property="advice" name="docsForm" value="<%=hqBuffer.toString() %>" rows="3" >
											</html:textarea>
										...
										<tr>
											...
											<td>
												<html:textarea
													style="BORDER: #000000 1px dotted;text-align:left;background:#ebebeb;color:red"
													cols="75" property="advice" name="docsForm" value="<%=SjBuffer.toString() %>" rows="3" >
											</html:textarea>
