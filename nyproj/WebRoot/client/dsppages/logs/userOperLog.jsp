...
<html>
	...
	<body style="margin:0px"
		...
		<form name="userForm" action="<%=request.getContextPath()%>/clientAction.do?method=seleUserLogList"  method="post">
		...
		<table style="margin:0px;font-size:12px" border="0" width="800"
			...
			<tr>
				<td width="95%" height="25">
					<font face="Wingdings" size="2">&nbsp;l </font>当前位置：基础数据管理 → 用户操作日志
				</td>
			</tr>
		...
		<table style="font-size:12px;">
			<tr>
				...
				<td style="color:#568ba4">
					<input type="text" name="ckname" value="${ckname}"/>					
				</td>
				<td style="color:#568ba4">
					操作人：					
				</td>
