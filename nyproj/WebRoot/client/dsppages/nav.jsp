...
<html>
  ...
  <body topmargin="0" leftmargin="0"
    ...
    <tr valign="top">
      <th height="20" scope="col" width="35%"><div align="left"><span><font style="font-size:12";style="font-family:'宋体'" color="blue"><%=authorization.getName() +"："%> 您好！ 登录时间：<%=authorization.getRtime() %></font></span> &nbsp; &nbsp; &nbsp; &nbsp; <span><a href="<%=request.getContextPath()%>/client/dsppages/homePage.jsp" target="main"><font style="font-size: 12" color="#FF0000">首页</font></a></span>|
