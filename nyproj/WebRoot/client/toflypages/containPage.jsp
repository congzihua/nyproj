	...
	<div align="center"> 
 		 <div align="left" style="width: 1024"> 
				...
				<script type="text/javascript">
					if(window.parent.message.contentWindow != null && window.parent.message.contentWindow.document.getElementById("info")){
						window.parent.message.contentWindow.document.getElementById("info").innerHTML='已安检：${safeCheck+dengJi}';
