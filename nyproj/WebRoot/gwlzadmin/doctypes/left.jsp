...
<html>
	<head>
		...
		{  
	       ...
	       var dmpid =  src.getAttribute("dmId");
	        parent.main.location.href="docTypesAction.do?oper=list&dmpid="+dmpid;
		}
	...
	<body  style="margin:0px;">
		...
		<div style="margin-left:5px;margin-top:5px">
	     ...
	     tree = new WebFXLoadTree("中国记协", "../GetDepartMentTree.do",'','','../../images/foldericon.png','../../images/foldericon.png');
