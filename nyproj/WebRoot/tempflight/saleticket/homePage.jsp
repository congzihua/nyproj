...
<html>
  ...
  <div align="center">
  <form action="<%=request.getContextPath()%>/tfClientAction.do?method=toBlankInfo" method="post">
    ...
    <font color="red"><%=request.getAttribute("message")!=null&& request.getAttribute("message").toString().trim().equals("1")?"你选择的日期没有航班！":""%></font>
    </form>
    </div>
  </body>
</html>
