...
<html>
  ...
  <div align="center">
  <form action="<%=request.getContextPath()%>/tfClientAction.do?method=toFlyMainPage" method="post">
    <table border="0" width="1024" align="center">
    	<tr>
    		<td align="right" style="color:white;">日期：</td>
    		<td width="20%">
    		<table border="0">
						        <td width="70%" >
						        <input value="<%=date %>" name="orderdate" width="100%" readonly="readonly" id="orderdate">        </td>
						        <td align="left">
    		...
    		<td style="color:white;" align="right">起飞时间：</td>
    		<td>
    			<select name="hour">
