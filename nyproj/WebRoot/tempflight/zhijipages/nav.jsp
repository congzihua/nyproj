  ...
  <body topmargin="10" leftmargin="0"
    ...
    <tr valign="middle">
      <th  scope="col"  nowrap="nowrap"><div align="left"> &nbsp;
       <a href="<%=request.getContextPath()%>/tempflight/zhijipages/homePage.jsp" target="main"> <font style="font-size:12";style="font-family:'宋体'"color="#FFFFFF">首页</font></a>|
      <span><a href="<%=request.getContextPath()%>/tempflight/zhijipages/luggageInfo.jsp" target="main"><font style="font-size:12";style="font-family:'宋体'" color="#FFFFFF">乘客信息</font></a></span>|
      </div></th>
