...
int id = Integer.valueOf(request.getParameter("flightInfoId"));
...
<%}else{%>
	<input type="radio" value= "<%="V"+i+"-A"%>" name="tijiao" style="display:none">
	<img id=<%="V"+i+"-A"%>  name="seat" title="<%="V"+i+"-A"%>" src="<%=request.getContextPath()%>/image/20.jpg" width="35" height="35" border="1px" ondblclick="clickme(this.id);xuanzuo();" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);"  />
<%}%>
</th>
<th width="42">
...
<%}else{%>
	<input type="radio" value= "<%="V"+i+"-B"%>" name="tijiao" style="display:none">
	<img id='<%="V"+i+"-B"%>'  name="seat" title="<%="V"+i+"-B"%>" src="<%=request.getContextPath()%>/image/20.jpg" width="35" height="35" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);"  />
<%}%>
</th>
<th width="42">&nbsp;V&nbsp;</th>
...
<%}else{%>
	<input type="radio" value= "<%="V"+i+"-C" %>" name="tijiao" style="display:none">
	<img id='<%="V"+i+"-C"%>'  name="seat" title="<%="V"+i+"-C"%>" src="<%=request.getContextPath()%>/image/20.jpg" width="35" height="35" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);"  />
<%}%>
</th>
<th>
...
<%}else{%>
	<input type="radio" value= "<%="V"+i+"-D" %>" name="tijiao" style="display:none">
	<img id='<%="V"+i+"-D"%>'  name="seat" title="<%="V"+i+"-D"%>" src="<%=request.getContextPath()%>/image/20.jpg" width="35" height="35" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);"  />
<%}%>
</th>
</tr>
<%} %>
...
<%}else{%>
	<input type="radio" value= "<%=(k)+"A"%>"  name="tijiao" style="display:none">
	<img id='<%=(k)+"A"%>' name="seat" title="<%=(k)+"A"%>"src="<%=request.getContextPath()%>/image/20.jpg" width="20" height="20" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);" />
<%}%>
</th>
<th width="20" height="20">
...
<%}else{%>
	<input type="radio" value= "<%=(k)+"B"%>"  name="tijiao" style="display:none">
	<img id='<%=(k)+"B"%>'  name="seat" title="<%=(k)+"B"%>"src="<%=request.getContextPath()%>/image/20.jpg" width="20" height="20" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);" />
<%}%>
</th>
...
<%}else{%>
	...
	<input type="radio" value= "<%=(k)+"C"%>"  name="tijiao" style="display:none">
	<img id='<%=(k)+"C"%>'  name="seat" title="<%=(k)+"C"%>"src="<%=request.getContextPath()%>/image/20.jpg" width="20" height="20" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);" />
<%}%>
...
<%}else{%>
	<input type="radio" value= "<%=(k)+"D"%>"  name="tijiao" style="display:none">
	<img id='<%=(k)+"D"%>'  name="seat" title="<%=(k)+"D"%>"src="<%=request.getContextPath()%>/image/20.jpg" width="20" height="20" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);" />
<%}%>
...
<%}else{%>
	<input type="radio" value= "<%=(k)+"E"%>"  name="tijiao" style="display:none">
	<img id='<%=(k)+"E"%>'  name="seat" title="<%=(k)+"E"%>"src="<%=request.getContextPath()%>/image/20.jpg" width="20" height="20" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);" />
<%}%>
</th>
...
<%}else{%>
	<input type="radio" value= "<%=(k)+"F"%>"  name="tijiao" style="display:none">
	<img id='<%=(k)+"F"%>'  name="seat" title="<%=(k)+"F"%>"src="<%=request.getContextPath()%>/image/20.jpg" width="20" height="20" border="1px" ondblclick="clickme(this.id);xuanzuo();" onClick="javascript:clickme(this.id);" />
<%}%>
</th>
<%} %>
</table>
