...
<%
	...
	TempFlightinfo fInfo = (TempFlightinfo)request.getAttribute("flightinfo");
  	...
  	String flightDate = format.format(fInfo.getFlightDate());
  ...
  <body >
	<div align="center"> 
 		 <div align="left" style="width: 1024"> 
				...
				<FONT style="font-size:20px;text-shadow:Red;font-family:'黑体';"> 航班号： </FONT><FONT style="font-size:20px;text-shadow:Red;font-family:'黑体';color: #b22222">${flightinfo.flightNo}</font>&nbsp;&nbsp;<FONT style="font-size:20px;text-shadow:Red;font-family:'黑体';">起飞时间：</font><font style="font-size:20px;text-shadow:Red;font-family:'黑体';color:#b22222">${offLandTime} 星期 <%=weeks%></font>
